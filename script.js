// --- DATA: INJURY DATABASE (For Dropdowns) ---
const injuryDatabase = {
    "Ankle": ["Loose Tendon", "Sprain", "Achilles Tendonitis", "Impingement", "Fracture Recovery", "General Weakness"],
    "Knee": ["Patellar Tendonitis (Jumper's Knee)", "ACL Rehab", "Meniscus Tear", "IT Band Syndrome", "Osgood-Schlatter", "Runner's Knee"],
    "Hip": ["Impingement (FAI)", "Flexor Strain", "Labral Tear", "Adductor Strain", "Tightness/Immobility", "Snapping Hip"],
    "Back": ["Lower Back Pain", "Disc Issues", "Sciatica", "Muscle Strain", "Upper Back Stiffness"],
    "Shoulder": ["Rotator Cuff", "Impingement", "Labrum Tear", "Stability/Dislocation", "AC Joint"],
    "Groin": ["Sports Hernia", "Adductor Strain", "Gilmore's Groin"],
    "Foot": ["Plantar Fasciitis", "Stress Fracture", "Turf Toe", "Arch Pain"],
    "Wrist": ["Carpal Tunnel", "Sprain", "Tendinitis"],
    "Elbow": ["Tennis Elbow", "Golfer's Elbow"],
    "Hamstring": ["Strain (Grade 1)", "Strain (Grade 2)", "Tightness"],
    "Quad": ["Strain", "Contusion"]
};

// --- LOGIC: SMART BRAIN EXERCISE SWAPS ---
// Maps generic exercises to safe alternatives based on specific body parts
const INJURY_LOGIC = {
    "Hip": {
    ...
    "Wrist": {
        "banned": ["Bench Press", "Push Ups", "Front Squat", "Clean", "Handstand"],
        "swaps": {
            "Bench Press": "Pec Deck / Machine Press",
            "Push Ups": "Knuckle Push Ups",
    ...
    "Hamstring": {
        "banned": ["Sprints", "RDL", "Nordic Curls", "Deadlift", "Leg Curls"],
        "swaps": {
            "Sprints": "Bike Sprints",
            "RDL": "Hip Thrusts",
            "Nordic Curls": "Glute Bridges",
            "Deadlift": "Trap Bar Deadlift (Quads Bias)",
            "Leg Curls": "Step Ups"
        }
    },
    "Elbow": {
        "banned": ["Pull Ups", "Chin Ups", "Skullcrushers", "Bicep Curls"],
        "swaps": {
            "Pull Ups": "Lat Pulldown (Light)",
            "Chin Ups": "Rows",
            "Skullcrushers": "Tricep Pushdowns",
...
const app = {
    init: () => {
        ...
        if (savedData) {
            ...
            // Ensure perf_key exists (backward compatibility)
    ...
    views: {
        dashboard: () => {
            ...
            <div class="h-full overflow-y-auto custom-scrollbar p-5 space-y-6 pb-24 animate-fade-in">
                ...
                <div class="bg-neutral-900 border border-neutral-800 p-4 rounded-xl">
                    ...
                    <div class="flex justify-between items-center text-xs"><span class="text-neutral-400">Program Duration</span><span class="text-white font-mono uppercase bg-neutral-800 px-2 py-1 rounded border border-neutral-700">${duration} Weeks</span></div>
                </div>
                <div>
        ...
        training: () => {
            // Get the specific program based on goal
